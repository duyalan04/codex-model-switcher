...
function App() {
  ...
  return (
    <div className="flex h-screen w-full flex-col font-sans bg-[hsl(var(--background))] text-[hsl(var(--foreground))] overflow-hidden gap-5" style={{ padding: '32px' }}>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-mono font-medium text-[hsl(var(--muted-foreground))] opacity-70 px-1.5 py-0.5 rounded bg-[hsl(var(--muted))]/30 mt-0.5 border border-[hsl(var(--border))]/50">
                v{__APP_VERSION__}
              </span>
            </div>
      ...
      <div className="flex-1 min-h-0 min-w-0 px-1.5 pb-1 flex flex-col">
        <div className="grid grid-cols-2 gap-5 flex-1 min-h-0">
          ...
          <div className="min-w-0 flex flex-col gap-5 h-full">
            ...
            <section className="flex-1 min-h-0 flex flex-col">
              <QuotaPanel className="flex-1 min-h-0 flex flex-col" />
            </section>
          </div>
